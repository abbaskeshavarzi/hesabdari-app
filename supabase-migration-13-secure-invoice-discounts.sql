-- مرحله ۱۳: اصلاح تابع فاکتور برای نصب‌های قبلی
-- این migration باید بعد از migration-12 اجرا شود تا امضای دارای تخفیف، کنترل user_id
-- و اعتبارسنجی موجودی اتمیک هم‌زمان برقرار باشند.
